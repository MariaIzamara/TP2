...
coordenadas chaoL, terraL, addTorreL, bancoL, caminhoL;

//Tamanho dos objetos
coordenadas chaoT, terraT, addTorreT, entradaT, bancoT, caminhoT;
...
float corMaterial[3] = {0.2, 0.2, 0.2};
